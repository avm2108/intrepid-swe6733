...
/*     useEffect(() => {
    ...
    const [formState, setFormState] = useState({
        ...
        profilePictureHref: "", // Represents the actual file object
        profilePictureName: "",
    ...
    const handleImageChange = (e) => {
        ...
        reader.onloadend = () => {
            ...
            setFormState({
                ...formState,
                profilePictureHref: reader?.result || "",
                profilePictureName: file?.name || "",
                profilePictureCaption: formState?.profilePictureCaption || ""
            });
        };
...
/*         setFormState({ ...formState, profilePicture: files[0] ?? {}, profilePictureName: files[0]?.name || "", profilePictureCaption: formState?.profilePictureCaption || "" }); */
    ...
    const handleRemoveImage = () => {
        setFormState({ ...formState, profilePictureHref: "", profilePictureName: "", profilePictureCaption: "" });
    ...
    const handleSubmit = async (e) => {
        ...
        formData.append("profile", JSON.stringify(formState));
        ...
        <div className={styles.createContainer}>
            ...
            <form className={styles.createForm} onSubmit={handleSubmit}>
                ...
                <div>
                    ...
                    {!!formState.profilePictureHref && (
                    <>
                        <div className={styles.profilePictureContainer}>
                            {/* For binary file upload */}
                            {/* <img src={URL.createObjectURL?.(formState?.profilePicture || "")} width="125" height="125" alt="Profile" /> */}
                            <img src={formState?.profilePictureHref || ""} width="125" height="125" alt="Profile" />
